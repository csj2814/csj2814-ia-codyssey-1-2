...
![Structure](https://img.shields.io/badge/Structure-기승전결-orange?style=for-the-badge)
![Bonus](https://img.shields.io/badge/Bonus-3종_모두_포함-success?style=for-the-badge)

![Image AI](https://img.shields.io/badge/Image-Midjourney_v6-000000?style=flat-square)
![Video AI](https://img.shields.io/badge/Video-Runway_Gen--4-9146FF?style=flat-square)
![Audio AI](https://img.shields.io/badge/Audio-Suno_v4-FF6B35?style=flat-square)
![TTS](https://img.shields.io/badge/Voice-ElevenLabs_v3-1E88E5?style=flat-square)
![LipSync](https://img.shields.io/badge/LipSync-HeyGen-E91E63?style=flat-square)

<br>

<img src="./moodbrew_hero.png" alt="MoodBrew Brand Mood" width="720"/>
...
<tr><td align="center"><b>🎨 브랜드 컬러</b></td><td><img src="https://placehold.co/20x20/8B5E3C/8B5E3C.png"> <code>#8B5E3C</code> Espresso · <img src="https://placehold.co/20x20/E8C39E/E8C39E.png"> <code>#E8C39E</code> Latte · <img src="https://placehold.co/20x20/F5EBDD/F5EBDD.png"> <code>#F5EBDD</code> Cream · <img src="https://placehold.co/20x20/C5432C/C5432C.png"> <code>#C5432C</code> Terracotta</td></tr>
...
```mermaid
flowchart LR
    A[🎯 인지<br/>Awareness] --> B[💭 감성 공감<br/>Emotion]
    B --> C[📱 앱 다운로드<br/>Conversion]
    style A fill:#8B5E3C,color:#fff,stroke:#5C3D22,stroke-width:2px
    style B fill:#E8C39E,color:#000,stroke:#8B5E3C,stroke-width:2px
    style C fill:#C5432C,color:#fff,stroke:#8B2E1B,stroke-width:2px
```
...
```mermaid
flowchart TD
    A[📝 기획<br/>브랜드/메시지 확정] --> B[🎨 이미지 생성<br/>Midjourney v6]
    B --> C{스타일 일관성<br/>OK?}
    C -->|No| B
    C -->|Yes| D[🎬 이미지→비디오<br/>Runway Gen-4]
    D --> E[🎵 배경음악<br/>Suno v4]
    D --> F[🗣️ 내레이션<br/>ElevenLabs v3]
    F --> G[👄 립싱크<br/>HeyGen]
    E --> H[✂️ 통합 편집<br/>CapCut]
    G --> H
    H --> I[📱 3종 비율 렌더링<br/>16:9 / 9:16 / 1:1]
    I --> J[✅ 최종 영상<br/>MP4 H.264]

    style A fill:#F5EBDD,stroke:#8B5E3C
    style J fill:#8B5E3C,color:#fff,stroke:#5C3D22,stroke-width:3px
```
...
![Brand](https://img.shields.io/badge/Brand-MoodBrew-8B5E3C?style=flat-square)
